...
const AuthScreen = () => {
  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      const googleName = nameParts.length > 0 ? displayName : '';
      
      // Set local state to match Google data
      setName(googleName);
      setEmail(user.email || '');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(isLogin ? 'Logged in successfully' : 'Account created successfully');
  ...
  if (resetPassword) {
    return (
      <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden">
        {/* Background with light green effect */}
    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10 relative">
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div className="flex">
            <button 
              className={`flex-1 py-3 font-medium text-center transition-colors ${isLogin ? 'text-green-600 border-b-2 border-green-500' : 'text-gray-500'}`}
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Organization field (signup only) */}
              {!isLogin && (
                <div>
